...
| --- | --- | --- |
| REQ | Functional or non-functional requirement | REQ-025 |
| ADR | Architecture/design decision | ADR-021 |
| RISK | Technical, project, security, clinical, privacy, or operational risk | RISK-026 |
| DEF | Defect, inconsistency, or documentation mismatch | DEF-032 |
| CHG | Implemented change set, formatted CHG-YYYYMMDD-## | CHG-20260906-07 |
| TEST | Test case or verification procedure | TEST-101 |
| UNC | Unresolved uncertainty | UNC-019 |
| DOC | Documentation correction or addition | DOC-041 |
