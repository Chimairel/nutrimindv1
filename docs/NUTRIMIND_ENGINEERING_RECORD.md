...
| --- | --- | --- |
| REQ | Functional or non-functional requirement | REQ-024 |
| ADR | Architecture/design decision | ADR-020 |
| RISK | Technical, project, security, clinical, privacy, or operational risk | RISK-025 |
| DEF | Defect, inconsistency, or documentation mismatch | DEF-032 |
| CHG | Implemented change set, formatted CHG-YYYYMMDD-## | CHG-20260906-06 |
| TEST | Test case or verification procedure | TEST-100 |
| UNC | Unresolved uncertainty | UNC-018 |
| DOC | Documentation correction or addition | DOC-040 |
...
| ADR-017 | Use PayMongo first as a sandbox collection adapter; keep collection, durable entitlement grants, and nutritionist compensation as separate auditable domains; defer provider disbursements and all live-money use behind explicit readiness gates | Accepted; Phase 1 schema and pure-policy foundation implemented with migration unapplied | 2026-09-05 | Supplies a bounded 3-versus-6 swap entitlement and auditable persistence foundation while preserving common safety; provider adapter, webhook route/worker, UI, reconciliation runtime, provider approval, and legal/tax decisions remain pending | REQ-021, RISK-022, UNC-016, TEST-078 through TEST-082 |
...
| RISK-022 | A payment/subscription implementation could grant access from untrusted client redirects, duplicate or lose financial effects through webhook failure, expose payment or health data, misstate refunds/receipts, or create approval-volume incentives and unaudited nutritionist payouts | Financial/security/privacy/data integrity | High without the planned controls | Critical | Critical | ADR-017; raw-body signature verification; immutable idempotent webhook inbox and financial ledger; server reconciliation; durable period grants; data minimization; maker-checker refunds/compensation; capped workload bands; sandbox and production gates | Open; Phase 1 schema constraints and pure policies partially mitigate design risk, but nothing is migrated, integrated, or runtime-verified |
