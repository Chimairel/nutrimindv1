...
- **Batch 10 remains in progress.** Clean empty-database rehearsal, full browser action journeys, observed-candidate plan-to-library reuse, live Google/Gemini provider checks, and timezone job execution remain unverified. Exact evidence and limits are in [Batch 10 integrated journeys](BATCH_10_INTEGRATED_JOURNEYS.md).
