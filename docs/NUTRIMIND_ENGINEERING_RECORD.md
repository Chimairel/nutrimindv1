...
| --- | --- | --- |
| REQ | Functional or non-functional requirement | REQ-023 |
...
| CHG | Implemented change set, formatted CHG-YYYYMMDD-## | CHG-20260906-05 |
| TEST | Test case or verification procedure | TEST-099 |
| UNC | Unresolved uncertainty | UNC-018 |
| DOC | Documentation correction or addition | DOC-039 |
...
| `IngredientPriceSource`, `IngredientPricePublication`, `IngredientPriceGeography`, `IngredientPriceCommodity`, `IngredientPriceCommodityMapping`, `IngredientPriceObservation` | official source provenance, immutable snapshots, geographic scope, original/normalized commodity units, exact-or-uncertain FNRI mapping, and dated PHP centavo ranges | both additive migrations applied to shared development; restrictive FKs; append-only triggers; range/date/strict-normalization/mapping checks; explicit supersession | all six tables empty; no accepted geography, data import, repository, endpoint, UI, or runtime estimate |
