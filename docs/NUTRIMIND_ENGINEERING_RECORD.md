...
- Official PayMongo subscription, account-capability, card-vaulting, payment, testing, webhook, refund, pricing, payout/disbursement, account-verification, website, restricted-business, and invoice pages were accessed on September 5, 2026. The exact links and claim-level citations are retained in [`PAYMENT_SUBSCRIPTION_COMPENSATION_ARCHITECTURE.md`](PAYMENT_SUBSCRIPTION_COMPENSATION_ARCHITECTURE.md).
