...
| DEF | Defect, inconsistency, or documentation mismatch | DEF-032 |
| CHG | Implemented change set, formatted CHG-YYYYMMDD-## | CHG-20260906-15 |
| TEST | Test case or verification procedure | TEST-143 |
| UNC | Unresolved uncertainty | UNC-019 |
| DOC | Documentation correction or addition | DOC-049 |
