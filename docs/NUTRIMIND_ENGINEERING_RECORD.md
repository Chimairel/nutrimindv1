...
- Added a fresh verified email-account browser fixture and exercised metrics, national food preferences, no-condition and no-food-restriction declarations with confirmation, shopping day, three consents, onboarding completion, dashboard entry, and baseline report history. The complete five-test Batch 10 role-browser file passed against the local frontend/backend. All four browser fixture accounts were removed. Explicit acknowledgment of a newly regenerated nutrition report remains an open journey.
