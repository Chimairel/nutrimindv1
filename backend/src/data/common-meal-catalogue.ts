export const SUPPORTED_LIBRARY_ALLERGENS = ['SHELLFISH', 'NUTS', 'DAIRY', 'GLUTEN', 'EGGS'] as const;
...
export const COMMON_MEAL_CATALOGUE: CommonMealDefinition[] = [
  {
    ...
    ingredients: [
      ingredient('Rice, well-milled, boiled', 160, 'GRAINS'),
      ingredient('Egg, chicken, whole', 100, 'PROTEIN'),
      ingredient('Tomato', 60, 'VEGETABLES'),
    ],
  },
  {
    ...
    mealType: 'BREAKFAST',
    diets: omnivore,
    allergensPresent: ['GLUTEN', 'EGGS'],
    ingredients: [
      ingredient('Bread, pan de sal', 70, 'GRAINS'),
      ingredient('Egg, chicken, whole, boiled', 55, 'PROTEIN'),
      ingredient('Tomato', 50, 'VEGETABLES'),
    ],
  },
  {
    ...
    mealType: 'BREAKFAST',
    diets: vegetarian,
    allergensPresent: ['GLUTEN', 'NUTS'],
    ingredients: [
      ingredient('Oats, quick-cooking, ckd', 250, 'GRAINS'),
      ingredient('Banana, saba', 80, 'FRUITS'),
      ingredient('Peanut butter', 20, 'PROTEIN'),
    ],
  },
  {
    ...
    mealType: 'BREAKFAST',
    diets: vegetarian,
    allergensPresent: ['GLUTEN', 'DAIRY'],
    ingredients: [
      ingredient('Oats, quick-cooking, ckd', 250, 'GRAINS'),
      ingredient('Milk, cow', 150, 'DAIRY'),
      ingredient('Papaya fruit, ripe', 100, 'FRUITS'),
    ],
  },
  {
    ...
    ingredients: [
      ingredient('Bread, pan de sal', 70, 'GRAINS'),
      ingredient('Tuna flakes, in brine, cnd', 80, 'PROTEIN'),
      ingredient('Cucumber', 50, 'VEGETABLES'),
      ingredient('Tomato', 50, 'VEGETABLES'),
    ],
  },
  {
    ...
    ingredients: [
      ingredient('Rice, well-milled, boiled', 160, 'GRAINS'),
      ingredient('Soybean cheese, soft curd', 120, 'PROTEIN'),
      ingredient('Tomato', 70, 'VEGETABLES'),
      ingredient('Onion, Bombay bulb', 20, 'VEGETABLES'),
    ],
  },
  {
    ...
    ingredients: [
      ingredient('Rice, well-milled, boiled', 160, 'GRAINS'),
      ingredient('Sardines, in tomato sce, cnd', 100, 'PROTEIN'),
      ingredient('Tomato', 50, 'VEGETABLES'),
    ],
  },
  {
    ...
    allergensPresent: ['EGGS'],
    ingredients: [
      ingredient('Sweet potato, purple, boiled', 180, 'GRAINS'),
      ingredient('Egg, chicken, whole, boiled', 55, 'PROTEIN'),
      ingredient('Cucumber', 70, 'VEGETABLES'),
    ],
  },
  {
    ...
    allergensPresent: ['EGGS'],
    ingredients: [
      ingredient('Corn on cob, yellow, boiled', 150, 'GRAINS'),
      ingredient('Egg, chicken, whole, boiled', 55, 'PROTEIN'),
      ingredient('Tomato', 50, 'VEGETABLES'),
    ],
  },
  {
    ...
    ingredients: [
      ingredient('Bread, pan de sal', 70, 'GRAINS'),
      ingredient('Peanut butter', 20, 'PROTEIN'),
      ingredient('Apple, red', 120, 'FRUITS'),
    ],
  },
  {
  ...
  },
  {
    ...
    allergensPresent: [],
    ingredients: [
      ingredient('Corn on cob, yellow, boiled', 130, 'GRAINS'),
      ingredient('Papaya fruit, ripe', 120, 'FRUITS'),
    ],
  },
  {
    ...
    allergensPresent: [],
    ingredients: [
      ingredient('Soybean cheese, soft curd', 150, 'PROTEIN'),
      ingredient('Potato, boiled', 160, 'GRAINS'),
      ingredient('Tomato', 70, 'VEGETABLES'),
    ],
  },

  {
    ...
    allergensPresent: [],
    ingredients: [
      ingredient('Rice, well-milled, boiled', 180, 'GRAINS'),
      ingredient('Chicken breast', 130, 'PROTEIN'),
      ingredient('Pechay lvs, boiled', 100, 'VEGETABLES'),
      ingredient('Tomato', 50, 'VEGETABLES'),
    ],
  },
  {
    ...
    ingredients: [
      ingredient('Rice, well-milled, boiled', 180, 'GRAINS'),
      ingredient('Beef lean meat, boiled', 120, 'PROTEIN'),
      ingredient('Cabbage, green, boiled', 100, 'VEGETABLES'),
      ingredient('Onion, Bombay bulb, boiled', 25, 'VEGETABLES'),
    ],
  },
  {
    ...
    allergensPresent: [],
    ingredients: [
      ingredient('Rice, well-milled, boiled', 170, 'GRAINS'),
      ingredient('Pork Boston butt, lean, boiled', 110, 'PROTEIN'),
      ingredient('Carrot, boiled', 80, 'VEGETABLES'),
      ingredient('Cabbage, green, boiled', 80, 'VEGETABLES'),
    ],
  },
  {
    ...
    ingredients: [
      ingredient('Rice, well-milled, boiled', 180, 'GRAINS'),
      ingredient('Milkfish, broiled', 130, 'PROTEIN'),
      ingredient('Tomato', 70, 'VEGETABLES'),
      ingredient('Cucumber', 70, 'VEGETABLES'),
    ],
  },
  {
    ...
    ingredients: [
      ingredient('Rice, well-milled, boiled', 180, 'GRAINS'),
      ingredient('Tilapia', 130, 'PROTEIN'),
      ingredient('Tomato', 60, 'VEGETABLES'),
      ingredient('Cucumber', 60, 'VEGETABLES'),
      ingredient('Lettuce lvs & petioles', 40, 'VEGETABLES'),
    ],
  },
  {
    ...
    ingredients: [
      ingredient('Rice, well-milled, boiled', 180, 'GRAINS'),
      ingredient('Tuna flakes, in brine, cnd', 110, 'PROTEIN'),
      ingredient('Cucumber', 70, 'VEGETABLES'),
      ingredient('Tomato', 60, 'VEGETABLES'),
    ],
  },
  {
    ...
    ingredients: [
      ingredient('Rice, well-milled, boiled', 160, 'GRAINS'),
      ingredient('Mung bean seed, green, dried, boiled', 180, 'PROTEIN'),
      ingredient('Swamp cabbage lvs, boiled', 100, 'VEGETABLES'),
      ingredient('Tomato', 50, 'VEGETABLES'),
    ],
  },
  {
    ...
    ingredients: [
      ingredient('Rice, well-milled, boiled', 170, 'GRAINS'),
      ingredient('Soybean cheese, soft curd', 160, 'PROTEIN'),
      ingredient('Cabbage, green, boiled', 80, 'VEGETABLES'),
      ingredient('Carrot, boiled', 60, 'VEGETABLES'),
      ingredient('Tomato', 50, 'VEGETABLES'),
    ],
  },
  {
    ...
    ingredients: [
      ingredient('Rice, well-milled, boiled', 180, 'GRAINS'),
      ingredient('Sardines, in tomato sce, cnd', 120, 'PROTEIN'),
      ingredient('Pechay lvs, boiled', 100, 'VEGETABLES'),
    ],
  },
  {
    ...
    allergensPresent: [],
    ingredients: [
      ingredient('Chicken breast', 140, 'PROTEIN'),
      ingredient('Potato, boiled', 220, 'GRAINS'),
      ingredient('Carrot, boiled', 80, 'VEGETABLES'),
      ingredient('Cabbage, green, boiled', 80, 'VEGETABLES'),
    ],
  },
  {
    ...
    allergensPresent: [],
    ingredients: [
      ingredient('Soybean cheese, soft curd', 170, 'PROTEIN'),
      ingredient('Potato, boiled', 180, 'GRAINS'),
      ingredient('Pechay lvs, boiled', 100, 'VEGETABLES'),
      ingredient('Tomato', 50, 'VEGETABLES'),
    ],
  },
  {
    ...
    allergensPresent: [],
    ingredients: [
      ingredient('Mung bean seed, green, dried, boiled', 100, 'PROTEIN'),
      ingredient('Cabbage, green, boiled', 100, 'VEGETABLES'),
      ingredient('Carrot, boiled', 70, 'VEGETABLES'),
      ingredient('Tomato', 60, 'VEGETABLES'),
    ],
  },
  {
    ...
    ingredients: [
      ingredient('Corn on cob, yellow, boiled', 130, 'GRAINS'),
      ingredient('Soybean cheese, soft curd', 160, 'PROTEIN'),
      ingredient('Cabbage, green, boiled', 90, 'VEGETABLES'),
      ingredient('Tomato', 60, 'VEGETABLES'),
    ],
  },
  {
    ...
    ingredients: [
      ingredient('Soybean cheese, soft curd', 170, 'PROTEIN'),
      ingredient('Sweet potato, purple, boiled', 150, 'GRAINS'),
      ingredient('Cucumber', 70, 'VEGETABLES'),
      ingredient('Tomato', 50, 'VEGETABLES'),
    ],
  },
  {
    ...
    allergensPresent: ['EGGS'],
    ingredients: [
      ingredient('Egg, chicken, whole, boiled', 100, 'PROTEIN'),
      ingredient('Potato, boiled', 170, 'GRAINS'),
      ingredient('Pechay lvs, boiled', 100, 'VEGETABLES'),
      ingredient('Carrot, boiled', 60, 'VEGETABLES'),
      ingredient('Tomato', 50, 'VEGETABLES'),
    ],
...

  {
    ...
    allergensPresent: [],
    ingredients: [
      ingredient('Rice, well-milled, boiled', 140, 'GRAINS'),
      ingredient('Chicken breast', 110, 'PROTEIN'),
      ingredient('Carrot, boiled', 60, 'VEGETABLES'),
      ingredient('Cabbage, green, boiled', 80, 'VEGETABLES'),
    ],
  },
  ...
  },
  {
    ...
    allergensPresent: [],
    ingredients: [
      ingredient('Rice, well-milled, boiled', 150, 'GRAINS'),
      ingredient('Pork Boston butt, lean, boiled', 100, 'PROTEIN'),
      ingredient('Squash fruit, boiled', 140, 'VEGETABLES'),
      ingredient('Tomato', 50, 'VEGETABLES'),
    ],
  },
  {
    ...
    ingredients: [
      ingredient('Milkfish, broiled', 130, 'PROTEIN'),
      ingredient('Sweet potato, purple, boiled', 200, 'GRAINS'),
      ingredient('Cucumber', 80, 'VEGETABLES'),
      ingredient('Tomato', 50, 'VEGETABLES'),
    ],
  },
  {
    ...
    allergensPresent: [],
    ingredients: [
      ingredient('Tilapia', 140, 'PROTEIN'),
      ingredient('Corn on cob, yellow, boiled', 180, 'GRAINS'),
      ingredient('Pechay lvs, boiled', 90, 'VEGETABLES'),
      ingredient('Tomato', 50, 'VEGETABLES'),
    ],
  },
  {
    ...
    allergensPresent: [],
    ingredients: [
      ingredient('Tuna flakes, in brine, cnd', 120, 'PROTEIN'),
      ingredient('Potato, boiled', 220, 'GRAINS'),
      ingredient('Cucumber', 60, 'VEGETABLES'),
      ingredient('Tomato', 60, 'VEGETABLES'),
      ingredient('Lettuce lvs & petioles', 40, 'VEGETABLES'),
  ...
  },
  {
    ...
    ingredients: [
      ingredient('Rice, well-milled, boiled', 150, 'GRAINS'),
      ingredient('Mung bean seed, green, dried, boiled', 170, 'PROTEIN'),
      ingredient('Squash fruit, boiled', 120, 'VEGETABLES'),
      ingredient('Tomato', 50, 'VEGETABLES'),
    ],
  },
  {
  ...
  },
  {
    ...
    ingredients: [
      ingredient('Sardines, in tomato sce, cnd', 120, 'PROTEIN'),
      ingredient('Sweet potato, purple, boiled', 190, 'GRAINS'),
      ingredient('Pechay lvs, boiled', 100, 'VEGETABLES'),
    ],
  },
  {
    ...
    allergensPresent: [],
    ingredients: [
      ingredient('Rice, well-milled, boiled', 120, 'GRAINS'),
      ingredient('Chicken breast', 120, 'PROTEIN'),
      ingredient('Corn on cob, yellow, boiled', 100, 'GRAINS'),
      ingredient('Tomato', 70, 'VEGETABLES'),
    ],
  },
  {
  ...
  },
  {
    ...
    ingredients: [
      ingredient('Mung bean seed, green, dried, boiled', 100, 'PROTEIN'),
      ingredient('Cabbage, green, boiled', 120, 'VEGETABLES'),
      ingredient('Tomato', 70, 'VEGETABLES'),
      ingredient('Onion, Bombay bulb, boiled', 20, 'VEGETABLES'),
    ],
  },
  {
  ...
  },
  {
    ...
    ingredients: [
      ...
      ingredient('Soybean cheese, soft curd', 160, 'PROTEIN'),
      ingredient('Pechay lvs, boiled', 100, 'VEGETABLES'),
      ingredient('Carrot, boiled', 50, 'VEGETABLES'),
      ingredient('Onion, Bombay bulb, boiled', 20, 'VEGETABLES'),
    ],
  },
  {
    ...
    ingredients: [
      ingredient('Soybean cheese, soft curd', 170, 'PROTEIN'),
      ingredient('Papaya fruit, ripe', 140, 'FRUITS'),
      ingredient('Sweet potato, purple, boiled', 100, 'GRAINS'),
    ],
  },
  {
  ...
  },
  {
    ...
    allergensPresent: [],
    ingredients: [
      ingredient('Soybean cheese, soft curd', 180, 'PROTEIN'),
      ingredient('Potato, boiled', 180, 'GRAINS'),
      ingredient('Squash fruit, boiled', 120, 'VEGETABLES'),
      ingredient('Tomato', 60, 'VEGETABLES'),
    ],
  },
  {
    ...
    allergensPresent: [],
    ingredients: [
      ingredient('Mung bean seed, green, dried, boiled', 90, 'PROTEIN'),
      ingredient('Sweet potato, purple, boiled', 80, 'GRAINS'),
      ingredient('Pechay lvs, boiled', 110, 'VEGETABLES'),
      ingredient('Tomato', 60, 'VEGETABLES'),
    ],
  },
  {
    ...
    ingredients: [
      ingredient('Soybean cheese, soft curd', 180, 'PROTEIN'),
      ingredient('Potato, boiled', 180, 'GRAINS'),
      ingredient('Swamp cabbage lvs, boiled', 110, 'VEGETABLES'),
      ingredient('Tomato', 60, 'VEGETABLES'),
    ],
  },
  {
    ...
    ingredients: [
      ingredient('Mung bean seed, green, dried, boiled', 90, 'PROTEIN'),
      ingredient('Sweet potato, purple, boiled', 65, 'GRAINS'),
      ingredient('Squash fruit, boiled', 120, 'VEGETABLES'),
      ingredient('Pechay lvs, boiled', 100, 'VEGETABLES'),
    ],
  },
  {
    ...
    allergensPresent: [],
    ingredients: [
      ingredient('Rice, well-milled, boiled', 130, 'GRAINS'),
      ingredient('Soybean cheese, hard curd', 160, 'PROTEIN'),
      ingredient('Bitter melon/gourd fruit, boiled', 120, 'VEGETABLES'),
      ingredient('Tomato', 60, 'VEGETABLES'),
      ingredient('Onion, Bombay bulb', 20, 'VEGETABLES'),
    ],
  },
  {
    ...
    ingredients: [
      ingredient('Soybean cheese, hard curd', 160, 'PROTEIN'),
      ingredient('Chayote fruit, boiled', 160, 'VEGETABLES'),
      ingredient('String/Yard long bean pod, green, boiled', 100, 'VEGETABLES'),
      ingredient('Sweet potato, purple, boiled', 120, 'GRAINS'),
      ingredient('Tomato', 60, 'VEGETABLES'),
    ],
  },
];
