...
const routes: RouteDocumentation[] = [
  ...
  },
  {
    ...
    tag: 'Authentication',
    summary: 'Sign in an existing account with Google',
    public: true,
  },
  {
    method: 'post',
  ...
  },
  {
    ...
    tag: 'Authentication',
    summary: 'Legacy Google sign-in alias (login only)',
    public: true,
  },
  ...
  { method: 'get', path: '/api/user/meals/cycles', tag: 'Meals', summary: 'Read current and upcoming plan cycles' },
  {
    method: 'post',
    path: '/api/user/meals/cycles/{cycleId}/acknowledge-incomplete',
    tag: 'Meals',
    summary: 'Acknowledge an incomplete cycle grocery subset',
  },
  {
    method: 'post',
    path: '/api/user/meals/cycles/{cycleId}/start-shopping',
    tag: 'Meals',
    summary: 'Start shopping for a ready or acknowledged incomplete cycle',
  },
  ...
  {
    method: 'post',
    path: '/api/nutritionist/outside-meal-reviews/{id}/claim',
    tag: 'Nutritionist',
    summary: 'Claim an outside-meal estimate',
  },
  {
    method: 'patch',
  ...
  { method: 'get', path: '/api/admin/data/foods', tag: 'Data governance', summary: 'Search the FNRI food catalogue' },
  {
    ...
    tag: 'Data governance',
    summary: 'Inspect aggregate consumption rows',
  },
  {
    method: 'post',
    path: '/api/admin/data/sources',
    tag: 'Data governance',
    summary: 'Register a governed data source',
  },
  {
    method: 'patch',
    path: '/api/admin/data/sources/{id}',
    tag: 'Data governance',
    summary: 'Update source governance metadata',
  },
  {
    method: 'post',
    path: '/api/admin/data/releases',
    tag: 'Data governance',
    summary: 'Create a versioned draft release',
  },
  {
    method: 'post',
    path: '/api/admin/data/releases/{id}/consumption-import',
    tag: 'Data governance',
    summary: 'Import aggregate food-consumption CSV data',
  },
  {
    method: 'patch',
    path: '/api/admin/data/consumption-stats/{id}/mapping',
    tag: 'Data governance',
    summary: 'Map an aggregate food label to FNRI',
  },
  {
    method: 'post',
    path: '/api/admin/data/releases/{id}/stage',
    tag: 'Data governance',
    summary: 'Stage a validated release',
  },
  {
    method: 'post',
    path: '/api/admin/data/releases/{id}/publish',
    tag: 'Data governance',
    summary: 'Publish a staged release',
  },
  {
    method: 'post',
    path: '/api/admin/data/releases/{id}/rollback',
    tag: 'Data governance',
    summary: 'Restore a retired release',
  },
  {
    method: 'post',
    path: '/api/admin/data/food-aliases',
    tag: 'Data governance',
    summary: 'Create or verify an FNRI alias',
  },
