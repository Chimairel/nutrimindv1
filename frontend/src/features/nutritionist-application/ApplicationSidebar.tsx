...
export function ApplicationSidebar() {
  return (
    <aside className="futuristic-grid relative overflow-hidden rounded-[32px] bg-[#07100d] p-5 text-white lg:sticky lg:top-24 lg:h-fit lg:p-9">
      <span className="hidden lg:flex h-12 w-12 items-center justify-center rounded-2xl bg-brand-accent text-[#07100d]">
        <Stethoscope className="h-5 w-5" />
      </span>
      <p className="mt-3 lg:mt-7 font-mono text-[10px] font-bold uppercase tracking-[0.18em] text-brand-accent">
        Professional review team
      </p>
      <h1 className="mt-3 font-display text-2xl lg:text-4xl font-black leading-[1.02] tracking-[-0.045em]">
      ...
      <details className="mt-4 lg:mt-8">
        <summary className="cursor-pointer text-sm font-semibold text-brand-accent">
