    ...
    <div className="flex flex-col gap-5 text-left" aria-label="Loading meal plan schedule">
      ...
      <section className="rounded-[26px] border border-brand-border/70 bg-brand-surface/85 p-2 shadow-card">
        <div className="flex items-center gap-2">
          ...
          <Skeleton className="h-12 w-12 shrink-0 rounded-2xl border border-brand-border/70 bg-brand-bgAlt/60" />
              ...
              <div
                ...
                className={`flex min-w-[88px] flex-1 flex-col items-center justify-center rounded-2xl border px-3 py-2.5 gap-1.5 ${
                  i === 0
                    ...
                    : 'border-brand-border/40 bg-brand-bgAlt/40'
                }`}
              >
        ...
        <div className="grid grid-cols-1 gap-4 p-4 md:grid-cols-3 sm:p-5">
          {[...Array(3)].map((_, i) => (
            ...
            >
              <div>
                {/* Image Placeholder */}
                <Skeleton className="mb-3.5 h-36 w-full rounded-xl" />
