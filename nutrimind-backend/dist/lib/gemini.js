...
exports.generateGenerativeJSON = generateGenerativeJSON;
...
async function generateGenerativeJSON(prompt, systemInstruction, schema, temperature) {
    ...
    throw new Error(`🛑 All Gemini fallback models failed to resolve the request. Last error: ${lastError?.message || lastError}`);
}
