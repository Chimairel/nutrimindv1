...
- [`docs/PAYMENT_SUBSCRIPTION_COMPENSATION_ARCHITECTURE.md`](docs/PAYMENT_SUBSCRIPTION_COMPENSATION_ARCHITECTURE.md): accepted sandbox-first PayMongo architecture. TEST checkout, durable webhook intake, and injected reconciliation/payment projection are implemented locally; customer billing UI, recurring subscriptions, refunds, shared-database rollout, and production remain open.
